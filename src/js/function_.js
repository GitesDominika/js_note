...
// wylosuj 6 liczb bez powtórzeń z zakresu 1-49 - EGZAMIN
function drawDigits(quantity){
    const temp = [];

    while (temp.length < quantity){       // for kiedy wiadomo ile jest iteracji while kiedy nie bedziemy wiedzieli ilerazy mac sie powtorzyc//
